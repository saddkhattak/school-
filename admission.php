...
if(isset($_POST['submit']))
   ...
   mysqli_query($conn,"INSERT INTO `register` (`name`,`fname`,`email`,`mobile_number`,`address`,`class_id`,`images`) VALUES ('$name','$fname','$email','$mobile','$address','$class','$image')") or die(mysqli_error($conn));
...
<!--                  <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>-->
                ...
                ?>     
          <option value="<?php echo $row1['class_id'];?>"><?php echo $row1['class'];?></option>
                  <?php }?>
