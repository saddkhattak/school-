...
<style>
    ...
    <main role="main">
       <div  class="featurette-divider">
           ...
           <!-- FEATURETTES Area Start HEre -->
    
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">History of the paradise </h2>
      ...
      <div class="col-md-5 imagea">
       <img src="images/slide2.jpeg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid " width="600" height="600">
      </div>
    </div>
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading"> Our Mission And goals</h2>
...
Educating the nation since 1996</p>
      ...
      <div class="col-md-5 order-md-1">
        <img src="images/slide3.jpeg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid" width="600" height="600">
      </div>
    </div>
